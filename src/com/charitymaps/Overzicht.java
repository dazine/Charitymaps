...
public class Overzicht extends ListActivity {
	...
	private class RetrieveRSSFeeds extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			retrieveRSSFeed(
					"http://www.gowithus.nl/projects/android/rssfeed.xml",
					itemlist);
			rssadaptor = new RSSListAdaptor(Overzicht.this,
		...
		protected void onPreExecute() {
			progress = ProgressDialog.show(Overzicht.this, null, "Loading ...");
			super.onPreExecute();
		}
	...
	private class RSSListAdaptor extends ArrayAdapter<RSSItem> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (null == view) {
				LayoutInflater vi = (LayoutInflater) Overzicht.this
